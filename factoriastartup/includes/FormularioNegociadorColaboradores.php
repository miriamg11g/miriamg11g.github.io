...
class FormularioNegociadorColaboradores extends Formulario
{
    ...
    public function __construct($fila) {
        $this->fila = $fila;
        //parent::__construct('formBusqueda', ['urlRedireccion' => 'negociadorUsuario.php']);
    ...
    protected function procesaFormulario(&$datos){
        ...
        if (!$id_proyecto) {
           $this->errores['proyecto'] = 'No ha seleccionado ningún proyecto.';
       }
       else{        
           header("Location: negociadorProcesarBusquedaColaboradores.php?proyecto=$id_proyecto");
       }
