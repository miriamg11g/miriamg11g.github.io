...
class FormularioCalendarioAdmin extends Formulario
{
        ...
        $html .= '<h3>Eventos actuales</h3>';
            $html .= '<div class="listado">';
                ...
                foreach ($eventos as $evento) {
                    ...
                    $html .= '<button type="submit" class="botonCrear" formaction="calendarioEventoCrearAdmin.php">Crear Evento</button>';
                    $html .= '<button type="submit" class="botonEliminar" formaction="calendarioEventoEliminarAdmin.php">Eliminar Evento</button>';
                    $html .= '<button type="submit" class="botonModificar" formaction="calendarioEventoModificarAdmin.php">Modificar Evento</button>';
                    $html .= '</form>';
                    $html .= '</div>';
    ...
    private function generaCalendario($mes_actual, $anio_actual) {
        ...
        for ($i = 1; $i < $diaSemana; $i++) {
            $calendario .= '<td class="otro-mes">' . ($diasEnMes - $diaSemana + $i + 1) . '</td>';
        }
        ...
        for ($i = $diaSemana; $i <= 7; $i++) {
            ...
            if ($this->hayEventosEnFecha($contador, $mes_actual, $anio_actual)) {
